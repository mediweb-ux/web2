<script lang="ts">
	...
	$: iconPaths = {
		...
		'users': 'M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197m-13.8 0A6 6 0 003 15v6m0 0v-5.197',
		'zap': 'M13 10V3L4 14h7v7l9-11h-7z',
		'mobile': 'M12 18h.01M8 21h8a2 2 0 002-2V5a2 2 0 00-2-2H8a2 2 0 00-2 2v14a2 2 0 002 2z',
		'layers': 'M12 2l3.09 6.26L22 9l-5.91.74L12 16l-4.09-6.26L2 9l5.91-.74L12 2z',
		'search': 'M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z',
		'accessibility': 'M16 4a4 4 0 11-8 0 4 4 0 018 0zM23 20c0 1-1 2-1 2H2s-1-1-1-2 1-4 6-4 6 3 6 4zm-6-8a2 2 0 11-4 0 2 2 0 014 0z',
...
<svg
	...
	fill={name === 'loading' ? 'none' : 'currentColor'}
	stroke={name === 'loading' ? 'currentColor' : 'none'}
	stroke-width={name === 'loading' ? '2' : '0'}
	viewBox="0 0 20 20"
...
>
	...
	{#if name === 'loading'}
		...
		<path class="opacity-75" fill="currentColor" d="M2 10a8 8 0 018-8V0C4.477 0 0 4.477 0 10h2zm2 5.291A7.962 7.962 0 012 10H0c0 3.042 1.135 5.824 3 7.938l1-2.647z"></path>
	{:else if name === 'menu'}
